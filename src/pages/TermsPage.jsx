      ...
      <div className="w-full p-8 bg-white shadow-lg rounded-md">
        ...
        <div className="prose prose-lg">
          <p className="text-gray-700 mb-4">
            Welcome to Discount Pro. By accessing or using this website, you
          ...
          <p className="text-gray-700 mb-4">
            These Terms and Conditions govern your use of our website, Discount
            Pro ("the Service"), and the purchase of any products or services
            offered by us. Please read these Terms carefully before using our
            Service.
          </p>
          ...
          <p className="text-gray-700 mb-4">
            ...
            accordance with our guidelines. You may not use the Service in any
          ...
          <p className="text-gray-700 mb-4">
            ...
            and to update your information if necessary. You are responsible
          ...
          <p className="text-gray-700 mb-4">
            ...
            software, available on the Service is the property of Discount Pro
          ...
          <ul className="list-disc pl-6 mt-2 text-gray-700">
            ...
            <li>
              Using the Service to transmit malicious software, viruses, or
              other harmful code.
            </li>
          ...
          <p className="text-gray-700 mb-4">
            ...
            our sole discretion if you violate these Terms. Upon termination,
          ...
          <p className="text-gray-700 mb-4">
            ...
            guarantee that the Service will be error-free, secure, or available
            at all times.
          </p>
          ...
          <p className="text-gray-700 mb-4">
            ...
            principles. Any disputes related to these Terms shall be subject to
          ...
          <p className="text-gray-700 mb-4">
            ...
            contact us at:
            <br />
            <strong>Email:</strong> support@discountpro.com
            <br />
            <strong>Address:</strong> 123 Discount Pro Lane, Tech City
          </p>
        </div>
